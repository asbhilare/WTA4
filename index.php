<!DOCTYPE html>
    ...
    <body>
        <img class="logo" src="logo.jpg"  alt="img">
        <div class="jumbotron text-center"><h1 style="color: red;">Restaurant Menu</h1></div>
        ...
        <footer>
            <!-- <div class="footer1">
                <div class="container-fluid"> -->
                    ...
                    <a style="color: black";href="mailto:asbhilare@mitaoe.ac.in">asbhilare@mitaoe.ac.in</a>
                    <!-- </div>
              </div> -->
        </footer>
        ...
        <script>
        let base_url = "http://localhost/WT_assignment_4/details.php";
